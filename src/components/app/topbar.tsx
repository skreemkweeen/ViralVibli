  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center gap-3 border-b border-line bg-bg/80 px-4 backdrop-blur-xl md:px-8">
      <button
        ...
        onClick={onMenu}
        className="grid size-9 shrink-0 place-items-center rounded-lg text-muted hover:bg-surface-2 hover:text-ink lg:hidden"
      >
      ...
      <button
        onClick={onSearch}
        className="flex h-9 flex-1 items-center gap-2.5 rounded-lg border border-line bg-surface px-3 text-left text-muted transition-colors hover:border-faint md:max-w-sm"
      >
